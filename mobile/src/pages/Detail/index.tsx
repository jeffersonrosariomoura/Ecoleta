...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=55${detail.point.whatsapp}&text=Tenho interesse na coleta de resíduos`);
    }
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage} source={{ uri: detail.point.image_url }} />
